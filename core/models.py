...
class Empresa(models.Model):
    ...
    recrutador = models.ForeignKey(Recrutador, on_delete=models.CASCADE, related_name='empresas')
    def __str__(self): return self.nome
...
class Entrevista(models.Model):
    ...
    recrutador = models.ForeignKey(Recrutador, on_delete=models.SET_NULL, null=True, related_name='entrevistas')
